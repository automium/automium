...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &extrasv1beta1.Backup{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// Watch the Applications created for the Backup
	err = c.Watch(&source.Kind{Type: &extrasv1beta1.Application{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &extrasv1beta1.Backup{},
	})
	if err != nil {
		return err
	}

	glog.Infoln("backup controller initialized")
...
// +kubebuilder:rbac:groups=extras.automium.io,resources=backups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=extras.automium.io,resources=backups/status,verbs=get;update;patch
func (r *ReconcileBackup) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Backup instance
	instance := &extrasv1beta1.Backup{}
	...
	// Define the desired backup Application object
	...
	if !reflect.DeepEqual(deploy.Spec, found.Spec) {
		...
		glog.Infof("Updating backup application %s/%s\n", deploy.ObjectMeta.Namespace, deploy.ObjectMeta.Name)
